var background = function(ctx) {
  ...
  function waveNiveau(e){
    ...
    if (e[2] < 100 && e[2] > 0){
      ctx.paintQuad(
        e[0] - 50,e[1] - e[2] / 10,
        e[0],e[1] - 5 - e[2] / 5 - e[2] / 10,
        e[0] + 50,e[1] - e[2] / 10,
        e[0],e[1] - 5 - e[2] / 10 - e[2] / 10
      );
    }
    else if (e[2] >= 100){
      ctx.paintQuad(
        e[0] - 50,e[1] - e[2] / 10,
        e[0],e[1] - 5 - (200-e[2]) / 5 - e[2] / 10,
        e[0] + 50,e[1] - e[2] / 10,
        e[0],e[1] - 5 - (200-e[2]) / 10 - e[2] / 10
      );
    }
    if (e[2] >= 200) {
      e[2] = -rnd(300)-100;
  ...
  function drawLeaf(){
    ...
    ctx.paintQuad(-5,0, 0,-12, 5,0, 0,5);
  }
  ...
  function waveMapNiveau(e){
    ...
    if (e[2] < 100 && e[2] > 0){
      ctx.paintQuad(
        e[0] - 25,e[1] - e[2] / 20,
        e[0],e[1] - 5 - e[2] / 10 - e[2] / 20,
        e[0] + 25,e[1] - e[2] / 20,
        e[0],e[1] - 5 - e[2] / 20 - e[2] / 20
      );
    }
    else if (e[2] >= 100){
      ctx.paintQuad(
        e[0] - 25,e[1] - e[2] / 20,
        e[0],e[1] - 5 - (200-e[2]) / 10 - e[2] / 20,
        e[0] + 25,e[1] - e[2] / 20,
        e[0],e[1] - 5 - (200-e[2]) / 20 - e[2] / 20
      );
    }
    if (e[2] == 200) {
      e[2] = -rnd(200);
