  ...
  return {
    ...
    drawHit: function(ctx,x,y,z,n){
      ...
      for (var i = 0;i<j;i++){
        ...
        var s = 4 - i%2*(n/10*4);
        ctx.paintQuad(
          cX + s*Math.cos(Math.PI*2/j*i),cY + s*Math.sin(Math.PI*2/j*i),
          cX + s*15*Math.cos(Math.PI*2/j*(i+2)),cY + s*15*Math.sin(Math.PI*2/j*(i+2)),
          cX - s*Math.cos(Math.PI*2/j*i),cY - s*Math.sin(Math.PI*2/j*i),
          cX - s*15*Math.cos(Math.PI*2/j*(i+2)),cY - s*15*Math.sin(Math.PI*2/j*(i+2))
        );
        /*
